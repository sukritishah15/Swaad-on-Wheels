...
<form name=f3 method="post">
  <ul>
  <li><button type="submit" name="amenu" >View Menu</button></li>
  <li><button type="submit" name="aamenu" >Add to Menu</button></li>
  <li><button type="submit" name="aorder" >View Orders</button></li>
  <li><button type="submit" name="apay" >View Payment</button></li>
  <!--<li><button type="submit" name="adel" >Add Delivery</button></li>-->
  <li><button type="submit" name="vdel" >View Delivery</button>
  <li><button type="submit" name="apd" >Edit Personal details</button></li>
</ul>
</form>
...
if (isset($_POST['amenu'])) {
    ...
    else
    {
      ...
      <th style='text-align: left;padding: 8px;background-color: #4CAF50;color: white;width: 150px;'>Update Menu</th>
      </tr>";
...
else if (isset($_POST['aamenu'])) {
   echo '<div style="text-align: center;"><form method="post" action="includes/addm.php"><br><br>
        <input type="text" placeholder="Enter Dish Name" name="dname" style="width: 80%;padding: 12px 45px;"><br><br>
        <input type="text" placeholder="Enter Dish Price" name="dprice" style="width: 80%;padding: 12px 45px;"><br><br>
        <input type="text" placeholder="Enter Dish Description" name="ddesc" style="width: 80%;padding: 12px 45px;"><br><br>
        <input type="text" placeholder="Enter Dish Type (Veg/Non-Veg)" name="dtype" style="width: 80%;padding: 12px 45px;"><br><br>
        <input type="text" placeholder="Enter Dish Category" name="dcat" style="width: 80%;padding: 12px 45px;"><br><br>
        <button type="submit" class="bt" name="addm">Add to Menu</button>
   </form></div> ';
}

else if (isset($_POST['aorder'])) {
   //$cui = $_SESSION['userId'];
...
//data: data
   ...
   $sql = "SELECT * FROM payment;";
    ...
    else
    {
      ...
      <th style='text-align: left;padding: 8px;background-color: #4CAF50;color: white;width: 250px;'>Add Delivery </th>
...
/*onclick="fetch($itid)"*/
        echo '<tr>
                  ...
                  <td><a href="includes/addd.php?cdd=';
                  echo $c;
                 echo'&pdd=';
                 echo $p;
                 echo ' ">Add Delivery </a></td>
              </tr>';
        }
        //<form method="post" action="includes/addo.php">
        //<td style="text-align: left;padding: 8px;"><button type="submit" name="addtoo" id="but">Add To Order </button></td>
